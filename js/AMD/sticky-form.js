...
define(['lib/jquery/jquery.textareaCounter.plugin','lib/jquery/jquery.form'],
    function(counterPlugin, jqueryForm){
...
if (settings.noRefresh) {
    ...
    postform.ajaxForm({
        ...
        uploadProgress: function (event, position, total, percentComplete) {
            ...
            .attr('value', _('Отправка: ') + percentVal);
        },

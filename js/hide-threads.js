	...
	var do_hide_threads = function() {
		...
		$('<a class="hide-thread-link" style="float:left;margin-right:5px;text-decoration: none;" href="javascript:void(0)"><i class="fa fa-minus-square"></i></a><span> </span>')
			...
			.click(function() {
				...
				thread_container.find('div.post,img,p.fileinfo,.file-info,a.hide-thread-link,br').hide();
				...
				$('<a class="unhide-thread-link" style="float:left;margin-right:5px;margin-left:0px;text-decoration: none;" href="javascript:void(0)"><i class="fa fa-plus-square"></i></a><span> </span>')
					.insertBefore(hidden_div.find(':first'))
					.click(function() {
						delete hidden_data[board][id];
						store_data();
						thread_container.find('div.post,img,p.fileinfo,.file-info,a.hide-thread-link,br').show();
						$(this).remove();
						hidden_div.remove();
					});
